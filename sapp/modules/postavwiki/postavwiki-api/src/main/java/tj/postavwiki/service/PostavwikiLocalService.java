...
/**
 * Provides the local service interface for postavwiki. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see postavwikiLocalServiceUtil
...
public interface postavwikiLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link postavwikiLocalServiceUtil} to access the postavwiki local service. Add custom service methods to {@link tj.postavwiki.service.impl.postavwikiLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
