...
/**
 * Provides the local service interface for izvewenie_put. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see izvewenie_putLocalServiceUtil
...
public interface izvewenie_putLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link izvewenie_putLocalServiceUtil} to access the izvewenie_put local service. Add custom service methods to {@link tj.izvewenie.put.service.impl.izvewenie_putLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
