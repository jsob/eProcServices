...
/**
 * Provides the local service interface for oblasti. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see oblastiLocalServiceUtil
 * @see tj.oblasti.service.base.oblastiLocalServiceBaseImpl
 * @see tj.oblasti.service.impl.oblastiLocalServiceImpl
 * @generated
 */
@ProviderType
@Transactional(isolation = Isolation.PORTAL, rollbackFor =  {
	PortalException.class, SystemException.class})
public interface oblastiLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link oblastiLocalServiceUtil} to access the oblasti local service. Add custom service methods to {@link tj.oblasti.service.impl.oblastiLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<oblasti> getoblastis(int start, int end);
	...
	*/
	...
	public oblasti addoblasti(oblasti oblasti);
	...
	*/
	public oblasti createoblasti(long oblasti_id);
	...
	*/
	...
	public oblasti deleteoblasti(long oblasti_id) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public oblasti deleteoblasti(oblasti oblasti);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public oblasti fetchoblasti(long oblasti_id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public oblasti getoblasti(long oblasti_id) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public oblasti updateoblasti(oblasti oblasti);
}