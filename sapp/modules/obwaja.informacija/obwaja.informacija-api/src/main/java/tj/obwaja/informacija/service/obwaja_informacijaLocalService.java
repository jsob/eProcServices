...
/**
 * Provides the local service interface for obwaja_informacija. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see obwaja_informacijaLocalServiceUtil
...
public interface obwaja_informacijaLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link obwaja_informacijaLocalServiceUtil} to access the obwaja_informacija local service. Add custom service methods to {@link tj.obwaja.informacija.service.impl.obwaja_informacijaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<obwaja_informacija> getobwaja_informacijas(int start, int end);
	...
	*/
	...
	public obwaja_informacija addobwaja_informacija(
	...
	*/
	public obwaja_informacija createobwaja_informacija(
	...
	*/
	...
	public obwaja_informacija deleteobwaja_informacija(
		long obwaja_informacija_id) throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public obwaja_informacija fetchobwaja_informacija(
		long obwaja_informacija_id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public obwaja_informacija getobwaja_informacija(long obwaja_informacija_id)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public obwaja_informacija updateobwaja_informacija(
		obwaja_informacija obwaja_informacija);
}