...
/**
 * This class is used by SOAP remote services, specifically {@link tj.obwaja.informacija.service.http.obwaja_informacijaServiceSoap}.
 *
 * @author Brian Wing Shun Chan
 * @see tj.obwaja.informacija.service.http.obwaja_informacijaServiceSoap
 * @generated
 */
@ProviderType
public class obwaja_informacijaSoap implements Serializable {
	public static obwaja_informacijaSoap toSoapModel(obwaja_informacija model) {
		obwaja_informacijaSoap soapModel = new obwaja_informacijaSoap();
	...
	public static obwaja_informacijaSoap[] toSoapModels(
		obwaja_informacija[] models) {
		obwaja_informacijaSoap[] soapModels = new obwaja_informacijaSoap[models.length];
	...
	public static obwaja_informacijaSoap[][] toSoapModels(
		obwaja_informacija[][] models) {
		obwaja_informacijaSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new obwaja_informacijaSoap[models.length][models[0].length];
		}
		else {
			soapModels = new obwaja_informacijaSoap[0][0];
		}
	...
	public static obwaja_informacijaSoap[] toSoapModels(
		List<obwaja_informacija> models) {
		List<obwaja_informacijaSoap> soapModels = new ArrayList<obwaja_informacijaSoap>(models.size());

		for (obwaja_informacija model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new obwaja_informacijaSoap[soapModels.size()]);
	}

	public obwaja_informacijaSoap() {
	}
