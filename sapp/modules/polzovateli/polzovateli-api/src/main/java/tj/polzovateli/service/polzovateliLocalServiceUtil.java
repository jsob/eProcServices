...
/**
 * Provides the local service utility for polzovateli. This utility wraps
 * {@link tj.polzovateli.service.impl.polzovateliLocalServiceImpl} and is the
 ...
 */
@ProviderType
public class polzovateliLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link tj.polzovateli.service.impl.polzovateliLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static int getpolzovatelisCount() {
		return getService().getpolzovatelisCount();
	}
	...
	*/
	public static java.util.List<tj.polzovateli.model.polzovateli> getpolzovatelis(
		int start, int end) {
		return getService().getpolzovatelis(start, end);
	}
	...
	*/
	public static tj.polzovateli.model.polzovateli addpolzovateli(
		tj.polzovateli.model.polzovateli polzovateli) {
		return getService().addpolzovateli(polzovateli);
	}
	...
	*/
	public static tj.polzovateli.model.polzovateli createpolzovateli(
		long polzovateli_id) {
		return getService().createpolzovateli(polzovateli_id);
	}
	...
	*/
	public static tj.polzovateli.model.polzovateli deletepolzovateli(
		long polzovateli_id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deletepolzovateli(polzovateli_id);
	}
	...
	*/
	public static tj.polzovateli.model.polzovateli deletepolzovateli(
		tj.polzovateli.model.polzovateli polzovateli) {
		return getService().deletepolzovateli(polzovateli);
	}

	public static tj.polzovateli.model.polzovateli fetchpolzovateli(
		long polzovateli_id) {
		return getService().fetchpolzovateli(polzovateli_id);
	}
	...
	* @throws PortalException if a polzovateli with the primary key could not be found
	*/
	public static tj.polzovateli.model.polzovateli getpolzovateli(
		long polzovateli_id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getpolzovateli(polzovateli_id);
	}
	...
	*/
	public static tj.polzovateli.model.polzovateli updatepolzovateli(
		tj.polzovateli.model.polzovateli polzovateli) {
		return getService().updatepolzovateli(polzovateli);
	}

	public static polzovateliLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<polzovateliLocalService, polzovateliLocalService> _serviceTracker =
		ServiceTrackerFactory.open(polzovateliLocalService.class);
}