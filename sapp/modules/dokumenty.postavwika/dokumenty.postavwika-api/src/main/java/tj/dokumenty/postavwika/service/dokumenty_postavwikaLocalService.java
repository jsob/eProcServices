...
/**
 * Provides the local service interface for dokumenty_postavwika. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see dokumenty_postavwikaLocalServiceUtil
...
public interface dokumenty_postavwikaLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link dokumenty_postavwikaLocalServiceUtil} to access the dokumenty_postavwika local service. Add custom service methods to {@link tj.dokumenty.postavwika.service.impl.dokumenty_postavwikaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<dokumenty_postavwika> getdokumenty_postavwikas(int start,
		int end);
	...
	*/
	...
	public dokumenty_postavwika adddokumenty_postavwika(
	...
	*/
	public dokumenty_postavwika createdokumenty_postavwika(
	...
	*/
	...
	public dokumenty_postavwika deletedokumenty_postavwika(
		long dokumenty_postavwika_id) throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public dokumenty_postavwika fetchdokumenty_postavwika(
		long dokumenty_postavwika_id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public dokumenty_postavwika getdokumenty_postavwika(
		long dokumenty_postavwika_id) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public dokumenty_postavwika updatedokumenty_postavwika(
		dokumenty_postavwika dokumenty_postavwika);
}