...
/**
 * Provides the local service interface for reestr_kontraktov. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see reestr_kontraktovLocalServiceUtil
...
public interface reestr_kontraktovLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link reestr_kontraktovLocalServiceUtil} to access the reestr_kontraktov local service. Add custom service methods to {@link tj.reestr.kontraktov.service.impl.reestr_kontraktovLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<reestr_kontraktov> getreestr_kontraktovs(int start, int end);
	...
	*/
	...
	public reestr_kontraktov addreestr_kontraktov(
	...
	*/
	public reestr_kontraktov createreestr_kontraktov(
	...
	*/
	...
	public reestr_kontraktov deletereestr_kontraktov(
		java.lang.String reestr_kontraktov_id) throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public reestr_kontraktov fetchreestr_kontraktov(
		java.lang.String reestr_kontraktov_id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public reestr_kontraktov getreestr_kontraktov(
		java.lang.String reestr_kontraktov_id) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public reestr_kontraktov updatereestr_kontraktov(
		reestr_kontraktov reestr_kontraktov);
}