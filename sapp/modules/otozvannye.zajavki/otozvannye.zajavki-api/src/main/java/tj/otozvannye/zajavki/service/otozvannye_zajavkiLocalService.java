...
/**
 * Provides the local service interface for otozvannye_zajavki. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see otozvannye_zajavkiLocalServiceUtil
...
public interface otozvannye_zajavkiLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link otozvannye_zajavkiLocalServiceUtil} to access the otozvannye_zajavki local service. Add custom service methods to {@link tj.otozvannye.zajavki.service.impl.otozvannye_zajavkiLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
