...
/**
 * Provides the local service utility for izvewenija. This utility wraps
 * {@link tj.izvewenija.service.impl.izvewenijaLocalServiceImpl} and is the
 ...
 */
@ProviderType
public class izvewenijaLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link tj.izvewenija.service.impl.izvewenijaLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static int getizvewenijasCount() {
	...
	*/
	public static java.util.List<tj.izvewenija.model.izvewenija> getizvewenijas(
		int start, int end) {
		return getService().getizvewenijas(start, end);
	}
	...
	*/
	public static tj.izvewenija.model.izvewenija addizvewenija(
		tj.izvewenija.model.izvewenija izvewenija) {
		return getService().addizvewenija(izvewenija);
	}
	...
	*/
	public static tj.izvewenija.model.izvewenija createizvewenija(
		long izvewenija_id) {
		return getService().createizvewenija(izvewenija_id);
	}
	...
	*/
	public static tj.izvewenija.model.izvewenija deleteizvewenija(
		long izvewenija_id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteizvewenija(izvewenija_id);
	}
	...
	*/
	public static tj.izvewenija.model.izvewenija deleteizvewenija(
		tj.izvewenija.model.izvewenija izvewenija) {
		return getService().deleteizvewenija(izvewenija);
	}

	public static tj.izvewenija.model.izvewenija fetchizvewenija(
		long izvewenija_id) {
		return getService().fetchizvewenija(izvewenija_id);
	}
	...
	* @throws PortalException if a izvewenija with the primary key could not be found
	*/
	public static tj.izvewenija.model.izvewenija getizvewenija(
		long izvewenija_id)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static tj.izvewenija.model.izvewenija updateizvewenija(
		tj.izvewenija.model.izvewenija izvewenija) {
		return getService().updateizvewenija(izvewenija);
	}

	public static izvewenijaLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<izvewenijaLocalService, izvewenijaLocalService> _serviceTracker =
		ServiceTrackerFactory.open(izvewenijaLocalService.class);
}