...
import tj.izvewenija.model.izvewenijaSoap;
...
public class izvewenijaModelImpl extends BaseModelImpl<izvewenija>
	 ...
	 */
	public static izvewenija toModel(izvewenijaSoap soapModel) {
		if (soapModel == null) {
			return null;
		}

		izvewenija model = new izvewenijaImpl();
	 ...
	 */
	public static List<izvewenija> toModels(izvewenijaSoap[] soapModels) {
		if (soapModels == null) {
			return null;
		}

		List<izvewenija> models = new ArrayList<izvewenija>(soapModels.length);

		for (izvewenijaSoap soapModel : soapModels) {
