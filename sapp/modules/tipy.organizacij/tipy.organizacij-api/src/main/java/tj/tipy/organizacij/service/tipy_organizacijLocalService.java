...
/**
 * Provides the local service interface for tipy_organizacij. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see tipy_organizacijLocalServiceUtil
...
public interface tipy_organizacijLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link tipy_organizacijLocalServiceUtil} to access the tipy_organizacij local service. Add custom service methods to {@link tj.tipy.organizacij.service.impl.tipy_organizacijLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
