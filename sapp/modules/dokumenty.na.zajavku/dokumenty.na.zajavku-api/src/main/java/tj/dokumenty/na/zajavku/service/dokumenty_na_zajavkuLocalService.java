...
/**
 * Provides the local service interface for dokumenty_na_zajavku. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see dokumenty_na_zajavkuLocalServiceUtil
...
public interface dokumenty_na_zajavkuLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link dokumenty_na_zajavkuLocalServiceUtil} to access the dokumenty_na_zajavku local service. Add custom service methods to {@link tj.dokumenty.na.zajavku.service.impl.dokumenty_na_zajavkuLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
