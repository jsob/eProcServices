...
/**
 * Provides the local service interface for podrazdelenija. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see podrazdelenijaLocalServiceUtil
...
public interface podrazdelenijaLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link podrazdelenijaLocalServiceUtil} to access the podrazdelenija local service. Add custom service methods to {@link tj.podrazdelenija.service.impl.podrazdelenijaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<podrazdelenija> getpodrazdelenijas(int start, int end);
	...
	*/
	...
	public podrazdelenija addpodrazdelenija(podrazdelenija podrazdelenija);
	...
	*/
	public podrazdelenija createpodrazdelenija(long podrazdelenija_id);
	...
	*/
	...
	public podrazdelenija deletepodrazdelenija(long podrazdelenija_id)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public podrazdelenija deletepodrazdelenija(podrazdelenija podrazdelenija);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public podrazdelenija fetchpodrazdelenija(long podrazdelenija_id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public podrazdelenija getpodrazdelenija(long podrazdelenija_id)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public podrazdelenija updatepodrazdelenija(podrazdelenija podrazdelenija);
}