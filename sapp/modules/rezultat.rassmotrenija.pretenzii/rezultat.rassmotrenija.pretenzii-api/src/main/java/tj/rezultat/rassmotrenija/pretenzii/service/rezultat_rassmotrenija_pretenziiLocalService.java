...
/**
 * Provides the local service interface for rezultat_rassmotrenija_pretenzii. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see rezultat_rassmotrenija_pretenziiLocalServiceUtil
...
public interface rezultat_rassmotrenija_pretenziiLocalService
	extends BaseLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link rezultat_rassmotrenija_pretenziiLocalServiceUtil} to access the rezultat_rassmotrenija_pretenzii local service. Add custom service methods to {@link tj.rezultat.rassmotrenija.pretenzii.service.impl.rezultat_rassmotrenija_pretenziiLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
