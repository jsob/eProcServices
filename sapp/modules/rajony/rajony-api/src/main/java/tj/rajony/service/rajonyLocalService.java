...
/**
 * Provides the local service interface for rajony. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see rajonyLocalServiceUtil
...
public interface rajonyLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link rajonyLocalServiceUtil} to access the rajony local service. Add custom service methods to {@link tj.rajony.service.impl.rajonyLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<rajony> getrajonies(int start, int end);
	...
	*/
	...
	public rajony addrajony(rajony rajony);
	...
	*/
	public rajony createrajony(long rajony_id);
	...
	*/
	...
	public rajony deleterajony(long rajony_id) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public rajony deleterajony(rajony rajony);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public rajony fetchrajony(long rajony_id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public rajony getrajony(long rajony_id) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public rajony updaterajony(rajony rajony);
}