...
/**
 * Provides the local service utility for prichiny_otmeny. This utility wraps
 * {@link tj.prichiny.otmeny.service.impl.prichiny_otmenyLocalServiceImpl} and is the
 ...
 */
@ProviderType
public class prichiny_otmenyLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link tj.prichiny.otmeny.service.impl.prichiny_otmenyLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static int getprichiny_otmeniesCount() {
		return getService().getprichiny_otmeniesCount();
	}
	...
	*/
	public static java.util.List<tj.prichiny.otmeny.model.prichiny_otmeny> getprichiny_otmenies(
		int start, int end) {
		return getService().getprichiny_otmenies(start, end);
	}
	...
	*/
	public static tj.prichiny.otmeny.model.prichiny_otmeny addprichiny_otmeny(
		tj.prichiny.otmeny.model.prichiny_otmeny prichiny_otmeny) {
		return getService().addprichiny_otmeny(prichiny_otmeny);
	}
	...
	*/
	public static tj.prichiny.otmeny.model.prichiny_otmeny createprichiny_otmeny(
		long prichiny_otmeny_id) {
		return getService().createprichiny_otmeny(prichiny_otmeny_id);
	}
	...
	*/
	public static tj.prichiny.otmeny.model.prichiny_otmeny deleteprichiny_otmeny(
		long prichiny_otmeny_id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteprichiny_otmeny(prichiny_otmeny_id);
	}
	...
	*/
	public static tj.prichiny.otmeny.model.prichiny_otmeny deleteprichiny_otmeny(
		tj.prichiny.otmeny.model.prichiny_otmeny prichiny_otmeny) {
		return getService().deleteprichiny_otmeny(prichiny_otmeny);
	}

	public static tj.prichiny.otmeny.model.prichiny_otmeny fetchprichiny_otmeny(
		long prichiny_otmeny_id) {
		return getService().fetchprichiny_otmeny(prichiny_otmeny_id);
	}
	...
	* @throws PortalException if a prichiny_otmeny with the primary key could not be found
	*/
	public static tj.prichiny.otmeny.model.prichiny_otmeny getprichiny_otmeny(
		long prichiny_otmeny_id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getprichiny_otmeny(prichiny_otmeny_id);
	}
	...
	*/
	public static tj.prichiny.otmeny.model.prichiny_otmeny updateprichiny_otmeny(
		tj.prichiny.otmeny.model.prichiny_otmeny prichiny_otmeny) {
		return getService().updateprichiny_otmeny(prichiny_otmeny);
	}

	public static prichiny_otmenyLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<prichiny_otmenyLocalService, prichiny_otmenyLocalService> _serviceTracker =
		ServiceTrackerFactory.open(prichiny_otmenyLocalService.class);
}