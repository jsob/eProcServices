...
/**
 * The persistence interface for the zakazchiki service.
 *
 * <p>
 ...
 */
@ProviderType
public interface zakazchikiPersistence extends BasePersistence<zakazchiki> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link zakazchikiUtil} to access the zakazchiki persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public void cacheResult(java.util.List<zakazchiki> zakazchikis);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, zakazchiki> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<zakazchiki> findAll();
	...
	*/
	public java.util.List<zakazchiki> findAll(int start, int end);
	...
	*/
	public java.util.List<zakazchiki> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<zakazchiki> orderByComparator);
