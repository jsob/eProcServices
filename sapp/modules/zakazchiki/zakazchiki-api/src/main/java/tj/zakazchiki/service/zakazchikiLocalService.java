...
/**
 * Provides the local service interface for zakazchiki. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see zakazchikiLocalServiceUtil
...
public interface zakazchikiLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link zakazchikiLocalServiceUtil} to access the zakazchiki local service. Add custom service methods to {@link tj.zakazchiki.service.impl.zakazchikiLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<zakazchiki> getzakazchikis(int start, int end);
	...
	*/
	...
	public zakazchiki addzakazchiki(zakazchiki zakazchiki);
	...
	*/
	public zakazchiki createzakazchiki(long zakazchiki_id);
	...
	*/
	...
	public zakazchiki deletezakazchiki(long zakazchiki_id)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public zakazchiki deletezakazchiki(zakazchiki zakazchiki);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public zakazchiki fetchzakazchiki(long zakazchiki_id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public zakazchiki getzakazchiki(long zakazchiki_id)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public zakazchiki updatezakazchiki(zakazchiki zakazchiki);
}