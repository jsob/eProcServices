...
/**
 * This class is used by SOAP remote services, specifically {@link tj.porjadok.raboty.komissii.service.http.porjadok_raboty_komissiiServiceSoap}.
 *
 * @author Brian Wing Shun Chan
 * @see tj.porjadok.raboty.komissii.service.http.porjadok_raboty_komissiiServiceSoap
 * @generated
 */
@ProviderType
public class porjadok_raboty_komissiiSoap implements Serializable {
	public static porjadok_raboty_komissiiSoap toSoapModel(
		porjadok_raboty_komissii model) {
		porjadok_raboty_komissiiSoap soapModel = new porjadok_raboty_komissiiSoap();
	...
	public static porjadok_raboty_komissiiSoap[] toSoapModels(
		porjadok_raboty_komissii[] models) {
		porjadok_raboty_komissiiSoap[] soapModels = new porjadok_raboty_komissiiSoap[models.length];
	...
	public static porjadok_raboty_komissiiSoap[][] toSoapModels(
		porjadok_raboty_komissii[][] models) {
		porjadok_raboty_komissiiSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new porjadok_raboty_komissiiSoap[models.length][models[0].length];
		}
		else {
			soapModels = new porjadok_raboty_komissiiSoap[0][0];
		}
	...
	public static porjadok_raboty_komissiiSoap[] toSoapModels(
		List<porjadok_raboty_komissii> models) {
		List<porjadok_raboty_komissiiSoap> soapModels = new ArrayList<porjadok_raboty_komissiiSoap>(models.size());

		for (porjadok_raboty_komissii model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new porjadok_raboty_komissiiSoap[soapModels.size()]);
	}

	public porjadok_raboty_komissiiSoap() {
	}
