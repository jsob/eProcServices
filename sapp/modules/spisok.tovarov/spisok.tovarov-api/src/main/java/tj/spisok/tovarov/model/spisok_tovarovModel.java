...
/**
 * The base model interface for the spisok_tovarov service. Represents a row in the &quot;sapp.spisok_tovarov&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link tj.spisok.tovarov.model.impl.spisok_tovarovModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link tj.spisok.tovarov.model.impl.spisok_tovarovImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public interface spisok_tovarovModel extends BaseModel<spisok_tovarov> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a spisok_tovarov model instance should use the {@link spisok_tovarov} interface instead.
	 */
	...
	@Override
	public CacheModel<tj.spisok.tovarov.model.spisok_tovarov> toCacheModel();
