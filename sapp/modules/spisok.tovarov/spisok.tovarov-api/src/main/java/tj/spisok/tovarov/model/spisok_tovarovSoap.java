...
/**
 * This class is used by SOAP remote services, specifically {@link tj.spisok.tovarov.service.http.spisok_tovarovServiceSoap}.
 *
 * @author Brian Wing Shun Chan
 * @see tj.spisok.tovarov.service.http.spisok_tovarovServiceSoap
 * @generated
 */
@ProviderType
public class spisok_tovarovSoap implements Serializable {
	public static spisok_tovarovSoap toSoapModel(spisok_tovarov model) {
		spisok_tovarovSoap soapModel = new spisok_tovarovSoap();
	...
	public static spisok_tovarovSoap[] toSoapModels(spisok_tovarov[] models) {
		spisok_tovarovSoap[] soapModels = new spisok_tovarovSoap[models.length];
	...
	public static spisok_tovarovSoap[][] toSoapModels(spisok_tovarov[][] models) {
		spisok_tovarovSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new spisok_tovarovSoap[models.length][models[0].length];
		}
		else {
			soapModels = new spisok_tovarovSoap[0][0];
		}
	...
	public static spisok_tovarovSoap[] toSoapModels(List<spisok_tovarov> models) {
		List<spisok_tovarovSoap> soapModels = new ArrayList<spisok_tovarovSoap>(models.size());

		for (spisok_tovarov model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new spisok_tovarovSoap[soapModels.size()]);
	}

	public spisok_tovarovSoap() {
	}
