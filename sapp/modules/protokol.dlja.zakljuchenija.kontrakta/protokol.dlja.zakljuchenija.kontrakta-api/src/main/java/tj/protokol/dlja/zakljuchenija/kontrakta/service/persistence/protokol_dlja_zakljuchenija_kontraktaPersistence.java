...
import tj.protokol.dlja.zakljuchenija.kontrakta.exception.NoSuchprotokol_dlja_zakljuchenija_kontraktaException;
import tj.protokol.dlja.zakljuchenija.kontrakta.model.protokol_dlja_zakljuchenija_kontrakta;

/**
 * The persistence interface for the protokol_dlja_zakljuchenija_kontrakta service.
 *
 * <p>
 ...
 * @see protokol_dlja_zakljuchenija_kontraktaUtil
 * @generated
 */
@ProviderType
public interface protokol_dlja_zakljuchenija_kontraktaPersistence
	extends BasePersistence<protokol_dlja_zakljuchenija_kontrakta> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link protokol_dlja_zakljuchenija_kontraktaUtil} to access the protokol_dlja_zakljuchenija_kontrakta persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public void cacheResult(
		java.util.List<protokol_dlja_zakljuchenija_kontrakta> protokol_dlja_zakljuchenija_kontraktas);
	...
	*/
	public protokol_dlja_zakljuchenija_kontrakta create(
	...
	*/
	public protokol_dlja_zakljuchenija_kontrakta remove(
		long protokol_dlja_zakljuchenija_kontrakta_id)
		throws NoSuchprotokol_dlja_zakljuchenija_kontraktaException;

	public protokol_dlja_zakljuchenija_kontrakta updateImpl(
		protokol_dlja_zakljuchenija_kontrakta protokol_dlja_zakljuchenija_kontrakta);
	...
	* @throws NoSuchprotokol_dlja_zakljuchenija_kontraktaException if a protokol_dlja_zakljuchenija_kontrakta with the primary key could not be found
	*/
	public protokol_dlja_zakljuchenija_kontrakta findByPrimaryKey(
		long protokol_dlja_zakljuchenija_kontrakta_id)
		throws NoSuchprotokol_dlja_zakljuchenija_kontraktaException;
	...
	*/
	public protokol_dlja_zakljuchenija_kontrakta fetchByPrimaryKey(
		long protokol_dlja_zakljuchenija_kontrakta_id);

	@Override
	public java.util.Map<java.io.Serializable, protokol_dlja_zakljuchenija_kontrakta> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<protokol_dlja_zakljuchenija_kontrakta> findAll();
	...
	*/
	public java.util.List<protokol_dlja_zakljuchenija_kontrakta> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<protokol_dlja_zakljuchenija_kontrakta> orderByComparator);
