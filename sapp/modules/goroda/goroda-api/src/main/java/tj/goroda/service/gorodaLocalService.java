...
/**
 * Provides the local service interface for goroda. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see gorodaLocalServiceUtil
...
public interface gorodaLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link gorodaLocalServiceUtil} to access the goroda local service. Add custom service methods to {@link tj.goroda.service.impl.gorodaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
