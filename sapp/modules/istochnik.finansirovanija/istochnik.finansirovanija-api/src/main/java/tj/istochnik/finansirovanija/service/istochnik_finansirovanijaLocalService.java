...
/**
 * Provides the local service interface for istochnik_finansirovanija. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see istochnik_finansirovanijaLocalServiceUtil
...
public interface istochnik_finansirovanijaLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link istochnik_finansirovanijaLocalServiceUtil} to access the istochnik_finansirovanija local service. Add custom service methods to {@link tj.istochnik.finansirovanija.service.impl.istochnik_finansirovanijaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
