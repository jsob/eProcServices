...
/**
 * The persistence interface for the zajavki_ot_postavwikov service.
 *
 * <p>
 ...
 * @see zajavki_ot_postavwikovUtil
 * @generated
 */
@ProviderType
public interface zajavki_ot_postavwikovPersistence extends BasePersistence<zajavki_ot_postavwikov> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link zajavki_ot_postavwikovUtil} to access the zajavki_ot_postavwikov persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public void cacheResult(
		java.util.List<zajavki_ot_postavwikov> zajavki_ot_postavwikovs);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, zajavki_ot_postavwikov> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<zajavki_ot_postavwikov> findAll();
	...
	*/
	public java.util.List<zajavki_ot_postavwikov> findAll(int start, int end);
	...
	*/
	public java.util.List<zajavki_ot_postavwikov> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<zajavki_ot_postavwikov> orderByComparator);
