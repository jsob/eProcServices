...
/**
 * The base model interface for the zajavki_ot_postavwikov service. Represents a row in the &quot;sapp.zajavki_ot_postavwikov&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link tj.zajavki.ot.postavwikov.model.impl.zajavki_ot_postavwikovModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link tj.zajavki.ot.postavwikov.model.impl.zajavki_ot_postavwikovImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public interface zajavki_ot_postavwikovModel extends BaseModel<zajavki_ot_postavwikov> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a zajavki_ot_postavwikov model instance should use the {@link zajavki_ot_postavwikov} interface instead.
	 */
	...
	@Override
	public CacheModel<tj.zajavki.ot.postavwikov.model.zajavki_ot_postavwikov> toCacheModel();
