...
/**
 * Provides the local service interface for naruwenija_v_izvewenii. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see naruwenija_v_izveweniiLocalServiceUtil
...
public interface naruwenija_v_izveweniiLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link naruwenija_v_izveweniiLocalServiceUtil} to access the naruwenija_v_izvewenii local service. Add custom service methods to {@link naruwenija.v.izvewenii.service.impl.naruwenija_v_izveweniiLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
