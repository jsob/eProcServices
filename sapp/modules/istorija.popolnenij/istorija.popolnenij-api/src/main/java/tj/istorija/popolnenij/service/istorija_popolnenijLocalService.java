...
/**
 * Provides the local service interface for istorija_popolnenij. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see istorija_popolnenijLocalServiceUtil
...
public interface istorija_popolnenijLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link istorija_popolnenijLocalServiceUtil} to access the istorija_popolnenij local service. Add custom service methods to {@link tj.istorija.popolnenij.service.impl.istorija_popolnenijLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<istorija_popolnenij> getistorija_popolnenijs(int start, int end);
	...
	*/
	...
	public istorija_popolnenij addistorija_popolnenij(
	...
	*/
	public istorija_popolnenij createistorija_popolnenij(
	...
	*/
	...
	public istorija_popolnenij deleteistorija_popolnenij(
		long istorija_popolnenij_id) throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public istorija_popolnenij fetchistorija_popolnenij(
		long istorija_popolnenij_id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public istorija_popolnenij getistorija_popolnenij(
		long istorija_popolnenij_id) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public istorija_popolnenij updateistorija_popolnenij(
		istorija_popolnenij istorija_popolnenij);
}