...
/**
 * The base model interface for the status_izvewenij service. Represents a row in the &quot;sapp.status_izvewenij&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link tj.status.izvewenij.model.impl.status_izvewenijModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link tj.status.izvewenij.model.impl.status_izvewenijImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public interface status_izvewenijModel extends BaseModel<status_izvewenij> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a status_izvewenij model instance should use the {@link status_izvewenij} interface instead.
	 */
	...
	@Override
	public CacheModel<tj.status.izvewenij.model.status_izvewenij> toCacheModel();
