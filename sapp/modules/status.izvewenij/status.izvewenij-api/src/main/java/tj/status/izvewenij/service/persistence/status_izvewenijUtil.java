...
/**
 * The persistence utility for the status_izvewenij service. This utility wraps {@link tj.status.izvewenij.service.persistence.impl.status_izvewenijPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 */
@ProviderType
public class status_izvewenijUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(status_izvewenij status_izvewenij) {
		getPersistence().clearCache(status_izvewenij);
	}
	 ...
	 */
	public static List<status_izvewenij> findWithDynamicQuery(
	 ...
	 */
	public static status_izvewenij update(status_izvewenij status_izvewenij) {
		return getPersistence().update(status_izvewenij);
	}
	...
	public static status_izvewenij update(status_izvewenij status_izvewenij,
		...
		return getPersistence().update(status_izvewenij, serviceContext);
	}
	...
	*/
	public static void cacheResult(status_izvewenij status_izvewenij) {
		getPersistence().cacheResult(status_izvewenij);
	}
	...
	*/
	public static void cacheResult(List<status_izvewenij> status_izvewenijs) {
		getPersistence().cacheResult(status_izvewenijs);
	}
	...
	*/
	public static status_izvewenij create(long status_izvewenij_id) {
	...
	*/
	public static status_izvewenij remove(long status_izvewenij_id)
		throws tj.status.izvewenij.exception.NoSuchstatus_izvewenijException {
		return getPersistence().remove(status_izvewenij_id);
	}

	public static status_izvewenij updateImpl(status_izvewenij status_izvewenij) {
		return getPersistence().updateImpl(status_izvewenij);
	}
	...
	* @throws NoSuchstatus_izvewenijException if a status_izvewenij with the primary key could not be found
	*/
	public static status_izvewenij findByPrimaryKey(long status_izvewenij_id)
		throws tj.status.izvewenij.exception.NoSuchstatus_izvewenijException {
	...
	*/
	public static status_izvewenij fetchByPrimaryKey(long status_izvewenij_id) {
		return getPersistence().fetchByPrimaryKey(status_izvewenij_id);
	}

	public static java.util.Map<java.io.Serializable, status_izvewenij> fetchByPrimaryKeys(
	...
	*/
	public static List<status_izvewenij> findAll() {
	...
	*/
	public static List<status_izvewenij> findAll(int start, int end) {
	...
	*/
	...
	public static status_izvewenijPersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<status_izvewenijPersistence, status_izvewenijPersistence> _serviceTracker =
		ServiceTrackerFactory.open(status_izvewenijPersistence.class);
}