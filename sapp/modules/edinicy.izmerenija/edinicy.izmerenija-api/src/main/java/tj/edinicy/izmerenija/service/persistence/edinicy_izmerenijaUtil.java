...
/**
 * The persistence utility for the edinicy_izmerenija service. This utility wraps {@link tj.edinicy.izmerenija.service.persistence.impl.edinicy_izmerenijaPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 */
@ProviderType
public class edinicy_izmerenijaUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(edinicy_izmerenija edinicy_izmerenija) {
		getPersistence().clearCache(edinicy_izmerenija);
	}
	 ...
	 */
	public static List<edinicy_izmerenija> findWithDynamicQuery(
	 ...
	 */
	public static edinicy_izmerenija update(
		edinicy_izmerenija edinicy_izmerenija) {
		return getPersistence().update(edinicy_izmerenija);
	}
	 ...
	 */
	public static edinicy_izmerenija update(
		edinicy_izmerenija edinicy_izmerenija, ServiceContext serviceContext) {
		return getPersistence().update(edinicy_izmerenija, serviceContext);
	}
	...
	*/
	public static void cacheResult(edinicy_izmerenija edinicy_izmerenija) {
		getPersistence().cacheResult(edinicy_izmerenija);
	}
	...
	*/
	public static void cacheResult(List<edinicy_izmerenija> edinicy_izmerenijas) {
		getPersistence().cacheResult(edinicy_izmerenijas);
	}
	...
	*/
	public static edinicy_izmerenija create(long edinicy_izmerenija_id) {
	...
	*/
	public static edinicy_izmerenija remove(long edinicy_izmerenija_id)
		throws tj.edinicy.izmerenija.exception.NoSuchedinicy_izmerenijaException {
		return getPersistence().remove(edinicy_izmerenija_id);
	}

	public static edinicy_izmerenija updateImpl(
		edinicy_izmerenija edinicy_izmerenija) {
		return getPersistence().updateImpl(edinicy_izmerenija);
	}
	...
	* @throws NoSuchedinicy_izmerenijaException if a edinicy_izmerenija with the primary key could not be found
	*/
	public static edinicy_izmerenija findByPrimaryKey(
	...
	*/
	public static edinicy_izmerenija fetchByPrimaryKey(
		long edinicy_izmerenija_id) {
		return getPersistence().fetchByPrimaryKey(edinicy_izmerenija_id);
	}

	public static java.util.Map<java.io.Serializable, edinicy_izmerenija> fetchByPrimaryKeys(
	...
	*/
	public static List<edinicy_izmerenija> findAll() {
	...
	*/
	public static List<edinicy_izmerenija> findAll(int start, int end) {
	...
	*/
	...
	public static edinicy_izmerenijaPersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<edinicy_izmerenijaPersistence, edinicy_izmerenijaPersistence> _serviceTracker =
		ServiceTrackerFactory.open(edinicy_izmerenijaPersistence.class);
}