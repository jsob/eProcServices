...
/**
 * This class is used by SOAP remote services, specifically {@link tj.informacija.o.razmewenii.service.http.informacija_o_razmeweniiServiceSoap}.
 *
 * @author Brian Wing Shun Chan
 * @see tj.informacija.o.razmewenii.service.http.informacija_o_razmeweniiServiceSoap
 * @generated
 */
@ProviderType
public class informacija_o_razmeweniiSoap implements Serializable {
	public static informacija_o_razmeweniiSoap toSoapModel(
		informacija_o_razmewenii model) {
		informacija_o_razmeweniiSoap soapModel = new informacija_o_razmeweniiSoap();
	...
	public static informacija_o_razmeweniiSoap[] toSoapModels(
		informacija_o_razmewenii[] models) {
		informacija_o_razmeweniiSoap[] soapModels = new informacija_o_razmeweniiSoap[models.length];
	...
	public static informacija_o_razmeweniiSoap[][] toSoapModels(
		informacija_o_razmewenii[][] models) {
		informacija_o_razmeweniiSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new informacija_o_razmeweniiSoap[models.length][models[0].length];
		}
		else {
			soapModels = new informacija_o_razmeweniiSoap[0][0];
		}
	...
	public static informacija_o_razmeweniiSoap[] toSoapModels(
		List<informacija_o_razmewenii> models) {
		List<informacija_o_razmeweniiSoap> soapModels = new ArrayList<informacija_o_razmeweniiSoap>(models.size());

		for (informacija_o_razmewenii model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new informacija_o_razmeweniiSoap[soapModels.size()]);
	}

	public informacija_o_razmeweniiSoap() {
	}
