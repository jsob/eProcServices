...
/**
 * Provides the local service utility for podtverzhdenie_na_uchastie. This utility wraps
 * {@link tj.podtverzhdenie.na.uchastie.service.impl.podtverzhdenie_na_uchastieLocalServiceImpl} and is the
 ...
 */
@ProviderType
public class podtverzhdenie_na_uchastieLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link tj.podtverzhdenie.na.uchastie.service.impl.podtverzhdenie_na_uchastieLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static int getpodtverzhdenie_na_uchastiesCount() {
		return getService().getpodtverzhdenie_na_uchastiesCount();
	}
	...
	*/
	public static java.util.List<tj.podtverzhdenie.na.uchastie.model.podtverzhdenie_na_uchastie> getpodtverzhdenie_na_uchasties(
		int start, int end) {
		return getService().getpodtverzhdenie_na_uchasties(start, end);
	}
	...
	*/
	public static tj.podtverzhdenie.na.uchastie.model.podtverzhdenie_na_uchastie addpodtverzhdenie_na_uchastie(
		tj.podtverzhdenie.na.uchastie.model.podtverzhdenie_na_uchastie podtverzhdenie_na_uchastie) {
		return getService()
				   .addpodtverzhdenie_na_uchastie(podtverzhdenie_na_uchastie);
	}
	...
	*/
	public static tj.podtverzhdenie.na.uchastie.model.podtverzhdenie_na_uchastie createpodtverzhdenie_na_uchastie(
		long podtverzhdenie_na_uchastie_id) {
		return getService()
				   .createpodtverzhdenie_na_uchastie(podtverzhdenie_na_uchastie_id);
	}
	...
	*/
	public static tj.podtverzhdenie.na.uchastie.model.podtverzhdenie_na_uchastie deletepodtverzhdenie_na_uchastie(
		long podtverzhdenie_na_uchastie_id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .deletepodtverzhdenie_na_uchastie(podtverzhdenie_na_uchastie_id);
	}
	...
	*/
	public static tj.podtverzhdenie.na.uchastie.model.podtverzhdenie_na_uchastie deletepodtverzhdenie_na_uchastie(
		tj.podtverzhdenie.na.uchastie.model.podtverzhdenie_na_uchastie podtverzhdenie_na_uchastie) {
		return getService()
				   .deletepodtverzhdenie_na_uchastie(podtverzhdenie_na_uchastie);
	}

	public static tj.podtverzhdenie.na.uchastie.model.podtverzhdenie_na_uchastie fetchpodtverzhdenie_na_uchastie(
		long podtverzhdenie_na_uchastie_id) {
		return getService()
				   .fetchpodtverzhdenie_na_uchastie(podtverzhdenie_na_uchastie_id);
	}
	...
	* @throws PortalException if a podtverzhdenie_na_uchastie with the primary key could not be found
	*/
	public static tj.podtverzhdenie.na.uchastie.model.podtverzhdenie_na_uchastie getpodtverzhdenie_na_uchastie(
		long podtverzhdenie_na_uchastie_id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .getpodtverzhdenie_na_uchastie(podtverzhdenie_na_uchastie_id);
	}
	...
	*/
	public static tj.podtverzhdenie.na.uchastie.model.podtverzhdenie_na_uchastie updatepodtverzhdenie_na_uchastie(
		tj.podtverzhdenie.na.uchastie.model.podtverzhdenie_na_uchastie podtverzhdenie_na_uchastie) {
		return getService()
				   .updatepodtverzhdenie_na_uchastie(podtverzhdenie_na_uchastie);
	}

	public static podtverzhdenie_na_uchastieLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<podtverzhdenie_na_uchastieLocalService, podtverzhdenie_na_uchastieLocalService> _serviceTracker =
		ServiceTrackerFactory.open(podtverzhdenie_na_uchastieLocalService.class);
}