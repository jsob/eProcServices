...
/**
 * Provides the local service interface for roli. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see roliLocalServiceUtil
...
public interface roliLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link roliLocalServiceUtil} to access the roli local service. Add custom service methods to {@link tj.roli.service.impl.roliLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
