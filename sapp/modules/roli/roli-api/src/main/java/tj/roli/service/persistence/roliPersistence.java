...
/**
 * The persistence interface for the roli service.
 *
 * <p>
 ...
 */
@ProviderType
public interface roliPersistence extends BasePersistence<roli> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link roliUtil} to access the roli persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public void cacheResult(java.util.List<roli> rolis);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, roli> fetchByPrimaryKeys(
	...
	* @return the rolis
	*/
	public java.util.List<roli> findAll();
	...
	*/
	public java.util.List<roli> findAll(int start, int end);
	...
	*/
	public java.util.List<roli> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<roli> orderByComparator);
