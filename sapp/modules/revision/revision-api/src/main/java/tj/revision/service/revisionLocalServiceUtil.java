...
/**
 * Provides the local service utility for revision. This utility wraps
 * {@link tj.revision.service.impl.revisionLocalServiceImpl} and is the
 ...
 * @see tj.revision.service.base.revisionLocalServiceBaseImpl
...
public class revisionLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link tj.revision.service.impl.revisionLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static java.util.List<tj.revision.model.revision> getrevisions(
		int start, int end) {
	...
	*/
	public static tj.revision.model.revision addrevision(
	...
	*/
	public static tj.revision.model.revision createrevision(long revision_id) {
		return getService().createrevision(revision_id);
	}
	...
	*/
	public static tj.revision.model.revision deleterevision(long revision_id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleterevision(revision_id);
	}
	...
	* @return the revision that was removed
	*/
	public static tj.revision.model.revision deleterevision(
		tj.revision.model.revision revision) {
		return getService().deleterevision(revision);
	}

	public static tj.revision.model.revision fetchrevision(long revision_id) {
		return getService().fetchrevision(revision_id);
	}
	...
	* @throws PortalException if a revision with the primary key could not be found
	*/
	public static tj.revision.model.revision getrevision(long revision_id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getrevision(revision_id);
	}
	...
	*/
	public static tj.revision.model.revision updaterevision(
		tj.revision.model.revision revision) {
	...
	private static ServiceTracker<revisionLocalService, revisionLocalService> _serviceTracker =
		ServiceTrackerFactory.open(revisionLocalService.class);
}