...
/**
 * The persistence interface for the konkursnaja_dokumentacija service.
 *
 * <p>
 ...
 * @see konkursnaja_dokumentacijaUtil
 * @generated
 */
@ProviderType
public interface konkursnaja_dokumentacijaPersistence extends BasePersistence<konkursnaja_dokumentacija> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link konkursnaja_dokumentacijaUtil} to access the konkursnaja_dokumentacija persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public void cacheResult(
		java.util.List<konkursnaja_dokumentacija> konkursnaja_dokumentacijas);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, konkursnaja_dokumentacija> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<konkursnaja_dokumentacija> findAll();
	...
	*/
	public java.util.List<konkursnaja_dokumentacija> findAll(int start, int end);
	...
	*/
	public java.util.List<konkursnaja_dokumentacija> findAll(int start,
		int end,
		com.liferay.portal.kernel.util.OrderByComparator<konkursnaja_dokumentacija> orderByComparator);
