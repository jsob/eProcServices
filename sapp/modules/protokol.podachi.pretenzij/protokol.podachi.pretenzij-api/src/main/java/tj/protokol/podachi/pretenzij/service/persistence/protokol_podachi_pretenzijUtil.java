...
/**
 * The persistence utility for the protokol_podachi_pretenzij service. This utility wraps {@link tj.protokol.podachi.pretenzij.service.persistence.impl.protokol_podachi_pretenzijPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 */
@ProviderType
public class protokol_podachi_pretenzijUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public static void clearCache(
		...
		getPersistence().clearCache(protokol_podachi_pretenzij);
	}
	 ...
	 */
	public static List<protokol_podachi_pretenzij> findWithDynamicQuery(
	 ...
	 */
	public static protokol_podachi_pretenzij update(
		protokol_podachi_pretenzij protokol_podachi_pretenzij) {
		return getPersistence().update(protokol_podachi_pretenzij);
	}
	...
	public static protokol_podachi_pretenzij update(
		...
		return getPersistence()
				   .update(protokol_podachi_pretenzij, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		protokol_podachi_pretenzij protokol_podachi_pretenzij) {
		getPersistence().cacheResult(protokol_podachi_pretenzij);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(protokol_podachi_pretenzijs);
	}
	...
	*/
	public static protokol_podachi_pretenzij create(
		long protokol_podachi_pretenzij_id) {
		return getPersistence().create(protokol_podachi_pretenzij_id);
	}
	...
	*/
	public static protokol_podachi_pretenzij remove(
		long protokol_podachi_pretenzij_id)
		throws tj.protokol.podachi.pretenzij.exception.NoSuchprotokol_podachi_pretenzijException {
		return getPersistence().remove(protokol_podachi_pretenzij_id);
	}

	public static protokol_podachi_pretenzij updateImpl(
		protokol_podachi_pretenzij protokol_podachi_pretenzij) {
		return getPersistence().updateImpl(protokol_podachi_pretenzij);
	}
	...
	* @throws NoSuchprotokol_podachi_pretenzijException if a protokol_podachi_pretenzij with the primary key could not be found
	*/
	public static protokol_podachi_pretenzij findByPrimaryKey(
		long protokol_podachi_pretenzij_id)
		throws tj.protokol.podachi.pretenzij.exception.NoSuchprotokol_podachi_pretenzijException {
		return getPersistence().findByPrimaryKey(protokol_podachi_pretenzij_id);
	}
	...
	*/
	public static protokol_podachi_pretenzij fetchByPrimaryKey(
		long protokol_podachi_pretenzij_id) {
		return getPersistence().fetchByPrimaryKey(protokol_podachi_pretenzij_id);
	}

	public static java.util.Map<java.io.Serializable, protokol_podachi_pretenzij> fetchByPrimaryKeys(
	...
	*/
	public static List<protokol_podachi_pretenzij> findAll() {
	...
	*/
	public static List<protokol_podachi_pretenzij> findAll(int start, int end) {
	...
	*/
	...
	public static protokol_podachi_pretenzijPersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<protokol_podachi_pretenzijPersistence, protokol_podachi_pretenzijPersistence> _serviceTracker =
		ServiceTrackerFactory.open(protokol_podachi_pretenzijPersistence.class);
}