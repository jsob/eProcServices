...
/**
 * The persistence interface for the godovoj_plan_zakupok service.
 *
 * <p>
 ...
 * @see godovoj_plan_zakupokUtil
 * @generated
 */
@ProviderType
public interface godovoj_plan_zakupokPersistence extends BasePersistence<godovoj_plan_zakupok> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link godovoj_plan_zakupokUtil} to access the godovoj_plan_zakupok persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public void cacheResult(
		java.util.List<godovoj_plan_zakupok> godovoj_plan_zakupoks);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, godovoj_plan_zakupok> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<godovoj_plan_zakupok> findAll();
	...
	*/
	public java.util.List<godovoj_plan_zakupok> findAll(int start, int end);
	...
	*/
	public java.util.List<godovoj_plan_zakupok> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<godovoj_plan_zakupok> orderByComparator);
