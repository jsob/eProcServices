...
/**
 * Provides the local service interface for prochaja_informacija_dlja_zajavki. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see prochaja_informacija_dlja_zajavkiLocalServiceUtil
...
public interface prochaja_informacija_dlja_zajavkiLocalService
	extends BaseLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link prochaja_informacija_dlja_zajavkiLocalServiceUtil} to access the prochaja_informacija_dlja_zajavki local service. Add custom service methods to {@link tj.prochaja.informacija.dlja.zajavki.service.impl.prochaja_informacija_dlja_zajavkiLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
