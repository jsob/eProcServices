...
/**
 * Provides the local service interface for dostup_po_podrazdelenijam. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see dostup_po_podrazdelenijamLocalServiceUtil
...
public interface dostup_po_podrazdelenijamLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link dostup_po_podrazdelenijamLocalServiceUtil} to access the dostup_po_podrazdelenijam local service. Add custom service methods to {@link tj.dostup.po.podrazdelenijam.service.impl.dostup_po_podrazdelenijamLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
