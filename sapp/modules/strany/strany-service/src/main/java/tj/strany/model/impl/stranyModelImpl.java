...
import tj.strany.model.stranySoap;
...
public class stranyModelImpl extends BaseModelImpl<strany>
	 ...
	 */
	public static strany toModel(stranySoap soapModel) {
		if (soapModel == null) {
			return null;
		}

		strany model = new stranyImpl();

		model.setNazvanie(soapModel.getNazvanie());
		model.setNazvanie_tj(soapModel.getNazvanie_tj());
		model.setStrany_id(soapModel.getStrany_id());
	 ...
	 */
	public static List<strany> toModels(stranySoap[] soapModels) {
		if (soapModels == null) {
			return null;
		}

		List<strany> models = new ArrayList<strany>(soapModels.length);

		for (stranySoap soapModel : soapModels) {
