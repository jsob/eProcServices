...
/**
 * Provides the local service interface for strany. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see stranyLocalServiceUtil
...
public interface stranyLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link stranyLocalServiceUtil} to access the strany local service. Add custom service methods to {@link tj.strany.service.impl.stranyLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
